                    ...
                    <div>
                        ...
                        <div class="star-color-show">
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                ...
                                @endif
                            @endfor
                            <span class="number-color-show ms-1">{{ $product->averageRating }}</span>
                        </div>
                        <br>
                ...
                <div class="col-md-4 mb-4">
                    <div class="mb-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="mb-0 hover-review-sum" style="font-size: 0.85rem;">(  {{ number_format($reviews->total()) }}件のレビュー )</span>
                        </div>
                    </div>
